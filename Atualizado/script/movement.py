...
def Detect_Roll(data):
	...
	cv2.rectangle(mapa, (int(data.data[1]/resolucao) + 600 - 5, int(data.data[0]/resolucao) + 6000 - 5), (int(data.data[3]/resolucao) + 600 + 5, int(data.data[2]/resolucao) + 6000 + 5), (0, 255, 0), -1)
