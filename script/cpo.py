	...
	if((-6.31>gps_x>-51.0)):
		if(objeto!=1):
			if(flag_desvio==0 and flag_volta == 0):
				msg_l = rospy.Publisher('/canaldoflag_v', Float32MultiArray, queue_size = 1)
...
def talker():
	...
	rospy.Subscriber('/canalderetornodovelodyne', Float32MultiArray, RETORNO_velodyne)
	rospy.spin()
