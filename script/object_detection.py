				...
				if stair:
					...
					if dist_esc/total < 3000 and dist_esc/total > 2800:
						...
						dest_y_global = dest_y_global/total_g
					        ...
					        # stair identificator, X destnation coordinate, Y destnation coordinate, Y deviation coordinate
						'''arg= (0, dest_x_global, dest_y_global, dest_y_stair)
						pub.data=arg
						msg.publish(pub)
						total_g = 0
						dest_x = 0
