...
goals = [(0.0, -1.2, 0, 180, 0, 0, 0),(-3.0, -3, 2, 180, 0, 0, 0),(-7.0, -1.95, 2, 180, 0, 0, 0),(-41.75, -2.01, 2, -45, -45, 0, 1),(-42.32, -2.01, 2, -45, 0, 0, 1),(-42.88, -2.01, 2, 0, 0, 0, 2),(-50.85, -2.01, -2, 0, 0, 0, 2),(-42.72, -2.01, -3, -45, 0, 0, 1),(-41.83, -2.01, -2, 0, -45, 0, 1), (-41.5, -2.01, -2, 0, 0, 0, 1), (-39.4, -2.01, 2, 180, 0, 0, 1),(-42.0, -3.4, 2, 180, 0, 0, 0),(-52.0, -3.4, 2, 0, 0, 0, 0),(-56.0, 0, 2, 0, 0, 0, 0),(-52.0, 3.4, 2, 0, 0, 0, 0),(-42.0, 3.4, 2, 180, 0, 0, 0),(-38.0, 1.85, -2, 180, 0, 0, 1), (-41.6, 1.85, -2, 35, 35, 0, 1), (-42.55, 1.85, -2, 180, 35, 2, 1), (-42.9, 1.85, -2, 180, 0, 2, 1), (-51.0, 1.85, 2, 180, 0, 2, 1), (-43.00, 1.85, 3, 0, 45, 0, 1), (-41.5, 1.85, 2, 180, 0, 0, 1), (-38, 1.85, 2, 180, 0, 0, 0), (-6.31, 1.85, 2, 180, 0, 0, 0), (-3.0, 3.0, 2, 180, 0, 0, 0)] #corrigir a subida de reh
index = len(goals)-2
...
def Fire_Coordinate(data):
	global goals, gps_y, gps_x, index
	x_rolo = data.data[0]
